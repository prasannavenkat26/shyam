...
import { ArrowRight, Mail, MapPin, Phone, Linkedin, Twitter, Instagram, Github } from 'lucide-react';
...
export function CTA() {
  return (
    <motion.section
      ...
      className="py-20 bg-gradient-to-r from-emerald-600/20 to-green-600/20 px-4 border-y border-emerald-500/30"
    >
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-xl text-slate-300 mb-8">
          Join thousands of users already making a difference through responsible e-waste recycling.
        </p>
        <Link to="/signup">
          <Button size="lg" className="bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 text-white border-0 h-12 px-8 text-lg">
            Get Started Free
